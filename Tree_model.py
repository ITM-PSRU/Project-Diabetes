...
X = dataset.drop(['Diabetes_binary', 'CholCheck', 'Smoker', 'Stroke', 'HeartDiseaseorAttack', 'PhysActivity','Fruits',
                  'Veggies', 'HvyAlcoholConsump', 'AnyHealthcare', 'NoDocbcCost', 'MentHlth', 'PhysHlth','DiffWalk', 'Sex', 'Education', 'Income'],axis="columns")
y = dataset['Diabetes_binary']

X_DT = X [['HighBP', 'HighBS', 'BMI', 'GenHlth', 'Age']]
